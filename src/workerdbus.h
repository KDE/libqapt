...
#ifndef WORKERDBUS_H_1275667016
#define WORKERDBUS_H_1275667016
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> workerQuestionResponse(const QVariantMap &response)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(response);
        return asyncCallWithArgumentList(QLatin1String("workerQuestionResponse"), argumentList);
    }
